...
namespace PathFinderAlgorithm
{
    public static class UserInterface
    {
        ...
        public static void PrintShortestPath(string startNode, string destNode, IDictionary<string, Node> vertices, IDictionary<Node, CheckPoint> checkPoints)
        {
        ...
        public static void InitGraph(string graphFilePath, IDictionary<string, Node> vertices, ICollection<Route> routes, IDictionary<Node, CheckPoint> checkPoints)
        {
            var projectDirectory = Directory.GetParent(Directory.GetCurrentDirectory()).Parent?.Parent?.FullName;
            if (projectDirectory != null && !File.Exists(projectDirectory + Path.DirectorySeparatorChar + graphFilePath))
            {
                throw new FileNotFoundException($"File {projectDirectory + Path.DirectorySeparatorChar + graphFilePath} not found");
            }
